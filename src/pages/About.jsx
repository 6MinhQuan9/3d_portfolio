  ...
  return (
    <section className="max-container">
      ...
      <div className="mt-5 flex flex-col gap-3 text-slate-500">
        <p>Software Engineer based in Vietnam, specializing in technical education through hands-on learning and building applications.</p>
      </div>
            ...
            {experiences.map((experience) => (
              ...
              >
                <div>
                  ...
                  <p className="text-black-500 font-medium font-base" style={{ marginTop: 0 }}>
